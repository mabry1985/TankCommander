...
public class PowerUp : MonoBehaviour
{
    ...
    protected virtual void PowerUpCollected (GameObject gameObject)
    {
        ...
        playerTank = gameObject.GetComponent<PlayerTank> ();
        ...
        gameObject.transform.parent = playerTank.gameObject.transform;
        gameObject.transform.position = playerTank.gameObject.transform.position;
